adata<-read.table("/data/liyuejuan/miniconda3/envs/mySVenv_python3/SV_procedure/test/result_stat/wilcox_test/s__Ruminococcus_C_callidus/input.txt",sep="	",header=T)
...
write.table(adata,file="/data/liyuejuan/miniconda3/envs/mySVenv_python3/SV_procedure/test/result_stat/wilcox_test/s__Ruminococcus_C_callidus/test_result.txt",row.names=F,sep="	")
