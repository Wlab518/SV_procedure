adata<-read.table("/data/liyuejuan/miniconda3/envs/mySVenv_python3/SV_procedure/test/result_stat/wilcox_test/s__Coprococcus_sp900066115/input.txt",sep="	",header=T)
...
write.table(adata,file="/data/liyuejuan/miniconda3/envs/mySVenv_python3/SV_procedure/test/result_stat/wilcox_test/s__Coprococcus_sp900066115/test_result.txt",row.names=F,sep="	")
