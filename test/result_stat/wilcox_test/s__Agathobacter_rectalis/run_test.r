adata<-read.table("/data/liyuejuan/miniconda3/envs/mySVenv_python3/SV_procedure/test/result_stat/wilcox_test/s__Agathobacter_rectalis/input.txt",sep="	",header=T)
...
write.table(adata,file="/data/liyuejuan/miniconda3/envs/mySVenv_python3/SV_procedure/test/result_stat/wilcox_test/s__Agathobacter_rectalis/test_result.txt",row.names=F,sep="	")
